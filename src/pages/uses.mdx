...
- Headphones:
  ...
  - Shure SE215 (rarely)
- Desk: Ikea Mittzon (standing desk)
- Chair: Ikea Lidkullen (stool)
- Phone: iPhone 12 Mini

## Everyday software

- Browser: Waterfox (main), Vivaldi, and Orion (iOS)
...
- Todos: Things
- App launcher and multi-tool: Raycast
- Notes:
  - Craft
  - Obsidian (dabbling with it)
  - Notion

## Multimedia

- Music streaming: Qobuz, Apple Music, Bandcamp
- Music player: Swinsian
- Media tag management: MusicBrainz Picard
- [Scrobbling](https://www.last.fm/about/trackmymusic): NepTunes (macOS) and Finale (iOS)
- Concert tracking: Songkick, Bandsintown
- Videos: YouTube, Netflix, VLC Player
...
- Editor: VS Code/Codium with [many extensions and customizations](https://github.com/herrherrmann/vs-code-setup/)
- Terminal: iTerm
...
This website is listed on these websites:
