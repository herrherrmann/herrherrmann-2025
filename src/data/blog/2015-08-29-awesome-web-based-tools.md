...
- [Gravit Designer (aka Corel Vector)](https://app.corelvector.com/), a design app for vector-based illustrations and more
- [Pixlr](https://pixlr.com/editor/), a Photoshop-like editor
- [Tridiv](http://tridiv.com/), a 3D editor that outputs 3D models as HTML and CSS
- [Audiotool](https://www.audiotool.com/), basically a complete [DAW](https://www.wikiwand.com/en/Digital_audio_workstation) in your browser
- [smallpdf.com](https://smallpdf.com/), a nice tool set for a lot of PDF actions (merging, splitting etc.)
...
However I'm excited for the future and the dawn of new possibilities, especially on the audio side of things (e.g. [Web Audio](https://github.com/WebAudio/web-audio-api) and [Web MIDI](https://github.com/WebAudio/web-midi-api) APIs).
